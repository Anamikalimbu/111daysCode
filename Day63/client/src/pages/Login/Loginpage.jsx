...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      ...
      const destination = from || (result.user.role === "admin" ? "/admin/dashboard" : "/profile");
    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-12 animate-fade-in">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="w-12 h-12 bg-gradient-to-br from-brand-500 to-brand-700 rounded-xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-brand-500/20">
        ...
        <div className="mt-4 card p-4">
          ...
          <div className="space-y-1 text-xs text-slate-600 dark:text-slate-400">
            <p><span className="font-medium">Admin:</span> admin@rbac.dev / admin123</p>
            <p><span className="font-medium">User:</span> user@rbac.dev / user1234</p>
          </div>
        </div>
      </div>
    </div>
